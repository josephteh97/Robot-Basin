...
# set the physics engine to PhysX
...
pose.r = gymapi.Quat.from_axis_angle(gymapi.Vec3(1, 0, 0), -0.5 * 3.142)
...
rotation_quat = gymapi.Quat.from_axis_angle(gymapi.Vec3(1, 0, 2), 3.142/2)
new_cam_pos = rotation_quat.rotate(cam_pos)

gym.viewer_camera_look_at(viewer, middle_env, new_cam_pos, cam_target)
